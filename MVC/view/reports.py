...
class Reports:
    def all_players_reports(self, players_loaded):
    ...
    def tournaments_reports(self, tournaments_loaded):
    ...
    def tournaments_reports_details(self, tournament_loaded, choice_details):
